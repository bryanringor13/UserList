...
const List = ({ navigation }: any) => {
    ...
    const navigateToDetailsHandler = (user_id: string) => {
        navigation.navigate(CONSTANT.SCREEN_DETAILS, { user_id })
    }
    ...
    return (
        <Container>
            ...
            <FlatList 
                data={user.users}
                numColumns={2}
                renderItem={({ item }) => <CardComponent item={item} action={navigateToDetailsHandler} />}
